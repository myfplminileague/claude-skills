...
Push the issue branch and open one PR against the default branch. Include:
...
Record the current CI snapshot. CI is the final deterministic gate; do not describe queued checks as green.
